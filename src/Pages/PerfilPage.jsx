                        ...
                        <div className="w3-card w3-round w3-white">
                            <div className="w3-container">
                                ...
                                <div className="w3-row-padding">
                                    <div className="w3-third"><img src="https://www.w3schools.com/w3images/lights.jpg" style={{ width: "100%" }} className="w3-margin-bottom" /></div>
                                    <div className="w3-third"><img src="https://www.w3schools.com/w3images/nature.jpg" style={{ width: "100%" }} className="w3-margin-bottom" /></div>
                                    <div className="w3-third"><img src="https://www.w3schools.com/w3images/mountains.jpg" style={{ width: "100%" }} className="w3-margin-bottom" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
